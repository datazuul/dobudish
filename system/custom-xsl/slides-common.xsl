...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="graphics.dir" select="'images/graphics'"/>
  <xsl:param name="script.dir" select="'images/browser'"/>
  <xsl:param name="css.stylesheet.dir" select="'images/browser'"/>
